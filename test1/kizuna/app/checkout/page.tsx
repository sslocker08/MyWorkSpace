  ...
  if (count() === 0) {
    return (
      <div className="min-h-screen pt-40 flex flex-col items-center justify-center gap-6 text-center px-6">
        ...
        <h1 className="font-cormorant italic text-3xl text-sumi">Votre panier est vide</h1>
        <Link
          href="/products"
          className="font-dm text-[12px] tracking-[0.14em] uppercase px-8 py-4 bg-sumi text-washi hover:bg-kon transition-colors duration-300"
        >
  ...
  return (
    <div className="min-h-screen pt-28 md:pt-36 pb-20">
      <div className="max-w-[1100px] mx-auto px-6 md:px-12">
        ...
        <h1 className="font-cormorant font-light italic text-4xl md:text-5xl text-sumi mb-12">
          Récapitulatif
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12">
          {/* Order items */}
          <div>
            <p className="font-dm text-[10px] tracking-[0.18em] uppercase text-brume mb-6">
              Articles ({count()})
            </p>
              ...
              {items.map(({ product, quantity }) => (
                <li key={product.id} className="flex gap-5 py-6">
                  ...
                  <div className="flex-1">
                    <p className="font-cormorant text-lg text-sumi leading-tight">{product.name.fr}</p>
                  ...
                  <p className="font-cormorant text-xl text-kincha shrink-0">
            ...
            <div className="mt-6 pt-6 border-t border-sumi/8 flex items-center justify-between">
              ...
              <p className="font-cormorant text-3xl text-sumi">{total().toLocaleString('fr-FR')} €</p>
            </div>
